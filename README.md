...
This repo contains the code for the frontend web applicaiton that displays information about my cat's bathroom habits. To check out the full codebase for the actual liter box, you can find that here: [https://github.com/JoeKarlsson/iot-kitty-litter-box](https://github.com/JoeKarlsson/iot-kitty-litter-box).
